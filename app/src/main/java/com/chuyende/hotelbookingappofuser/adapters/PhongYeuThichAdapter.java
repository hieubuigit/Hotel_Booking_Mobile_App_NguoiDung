...
public class PhongYeuThichAdapter extends RecyclerView.Adapter<PhongYeuThichAdapter.PhongYeuThichHolder> {
    ...
    public void onBindViewHolder(@NonNull PhongYeuThichHolder holder, int position) {
        ...
        holder.tvGiaThue.setText(phong.getGiaThue().toString());
    }
    ...
    public static class PhongYeuThichHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView getImvAnhDaiDienPhong() {
            return imvAnhDaiDienPhong;
        }

        public void setImvAnhDaiDienPhong(ImageView imvAnhDaiDienPhong) {
            this.imvAnhDaiDienPhong = imvAnhDaiDienPhong;
        }
        ...
        public TextView getTvDiaChiPhong() {
            return tvDiaChiPhong;
        }

        public void setTvDiaChiPhong(TextView tvDiaChiPhong) {
            this.tvDiaChiPhong = tvDiaChiPhong;
        }

        public RatingBar getRatRating() {
            return ratRating;
        }

        public void setRatRating(RatingBar ratRating) {
            this.ratRating = ratRating;
        }

        public TextView getTvGiaThue() {
            return tvGiaThue;
        }

        public void setTvGiaThue(TextView tvGiaThue) {
            this.tvGiaThue = tvGiaThue;
        }
