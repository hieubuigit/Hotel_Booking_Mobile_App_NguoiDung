...
import com.chuyende.hotelbookingappofuser.data_models.AccountSenderEmail;
        ...
        session = Session.getInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(AccountSenderEmail.EMAIL, AccountSenderEmail.PASSWORD);
                    }
                });
        try {
            ...
            mm.setFrom(new InternetAddress(AccountSenderEmail.EMAIL));
            //Adding receiver
